            ...
            <div class="weekly-content">
                <div class="weekly-content-wrapper">
                    ...
                    <div class="note-text">
                        ...
                        <ul>
                            <li><span class="curly-text" style="color:#008000">(attented): </span>HungNLHE130716 had attended this activity / Nguyễn Lương Hùng đã tham gia hoạt động này</li>
                            <li><span class="curly-text" style="color:#ff0000">(absent): </span>HungNLHE130716 had NOT attended this activity / Nguyễn Lương Hùng đã vắng mặt buổi này</li>
