<%-- 
    Document   : lecturer-management
    Created on : Sep 26, 2019, 8:08:58 PM
    Author     : luong
--%>
    ...
    <body>
        <div class="container">
            <%@include file="../../com.fap.fpt.templates/header.jsp" %>
                ...
                <div class="content">
                <div class="lecturer-manage-content timetable">
                    <h2 class="heading-primary">Lecturer Management</h2>
